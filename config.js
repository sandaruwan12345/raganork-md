...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://telegra.ph/file/f246662491a90a9fde687.jpg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    PMB: process.env.PMB || '~*_මම ආස නෑ මගෙ බොට්ගෙ ඔයා ඉන්බොක්ස් එනවට +94 77 912 2081 ඔය නම්බරේට ඉන්බොක්ස් එන්නෝ මම උබව BLOCK කරා.....🥺💗!_',
    ...
    BOT_INFO: process.env.BOT_INFO || '𝑹𝑨𝑺𝑯𝑼 𝑴𝑶𝑫𝒁;Skl11;0;https://telegra.ph/file/f246662491a90a9fde687.jpg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    ...
    BOT_NAME: process.env.BOT_NAME || '𝑵𝑹 𝑹𝑨𝑺𝑯𝑼 𝑴𝑶𝑫𝒁',
