...
module.exports = {
    ...
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭*𝑵𝑹 𝑹𝑨𝑺𝑯𝑼 𝑴𝑶𝑫𝒁¹¹ꫂ;Rashu bot;https://i.imgur.com/P7ziVhr.jpeg' : process.env.AUDIO_DATA,
